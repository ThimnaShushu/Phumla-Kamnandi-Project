...
namespace PhumlaKamnandi {
    ...
    public partial class PhumlaKamnandiDatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeeRow AddEmployeeRow(string EmployeeId, string Name, string Surname, string Id, string phone, string Email, string GENDER, int AGE) {
...
namespace PhumlaKamnandi.PhumlaKamnandiDatabaseDataSetTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Employee] WHERE (([EmployeeId] = @Original_EmployeeId) AND ([Name] = @Original_Name) AND ([Surname] = @Original_Surname) AND ([Id] = @Original_Id) AND ([phone] = @Original_phone) AND ([Email] = @Original_Email) AND ([GENDER] = @Original_GENDER) AND ([AGE] = @Original_AGE))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Employee] ([EmployeeId], [Name], [Surname], [Id], [phone], [Email], [GENDER], [AGE]) VALUES (@EmployeeId, @Name, @Surname, @Id, @phone, @Email, @GENDER, @AGE);
SELECT EmployeeId, Name, Surname, Id, phone, Email, GENDER, AGE FROM Employee WHERE (EmployeeId = @EmployeeId)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [EmployeeId] = @EmployeeId, [Name] = @Name, [Surname] = @Surname, [Id] = @Id, [phone] = @phone, [Email] = @Email, [GENDER] = @GENDER, [AGE] = @AGE WHERE (([EmployeeId] = @Original_EmployeeId) AND ([Name] = @Original_Name) AND ([Surname] = @Original_Surname) AND ([Id] = @Original_Id) AND ([phone] = @Original_phone) AND ([Email] = @Original_Email) AND ([GENDER] = @Original_GENDER) AND ([AGE] = @Original_AGE));
SELECT EmployeeId, Name, Surname, Id, phone, Email, GENDER, AGE FROM Employee WHERE (EmployeeId = @EmployeeId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PhumlaKamnandi.Properties.Settings.Default.PhumlaKamnandiDatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeId, Name, Surname, Id, phone, Email, GENDER, AGE FROM dbo.Employee" +
                "";
        ...
        public virtual int Delete(string Original_EmployeeId, string Original_Name, string Original_Surname, string Original_Id, string Original_phone, string Original_Email, string Original_GENDER, int Original_AGE) {
        ...
        public virtual int Insert(string EmployeeId, string Name, string Surname, string Id, string phone, string Email, string GENDER, int AGE) {
            if ((EmployeeId == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Surname, string Id, string phone, string Email, string GENDER, int AGE, string Original_EmployeeId, string Original_Name, string Original_Surname, string Original_Id, string Original_phone, string Original_Email, string Original_GENDER, int Original_AGE) {
            return this.Update(Original_EmployeeId, Name, Surname, Id, phone, Email, GENDER, AGE, Original_EmployeeId, Original_Name, Original_Surname, Original_Id, Original_phone, Original_Email, Original_GENDER, Original_AGE);
        }
    }
